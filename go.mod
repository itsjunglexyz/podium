module github.com/itsjunglexyz/podium
...
require (
	...
	github.com/itsjunglexyz/podium/leaderboard/v2 v2.0.0
...
replace github.com/itsjunglexyz/podium/leaderboard/v2 v2.0.0 => ./leaderboard
